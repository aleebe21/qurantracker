class QuranTracker:
  ...
  def plan(self, days):
      return f"Read {(self.total-self.current)/days:.1f} verses daily"

tracker = QuranTracker()
chapter = int(input("Enter chapter: "))
verse = int(input("Enter verse: "))
days = int(input("Enter number of days to complete: "))
print(tracker.update(chapter, verse))
print(tracker.plan(days))